...
This is Python based Exploratory Data Analysis on "US Accidents" dataset to find out and visualize different trends on accident occurrence and accident hotspot locations in order to get control over the same.
